...
class BeheerBioscopen
{
    ...
    public function makeBioscopenSelect($result)
    {
        ...
        while ($row = $result->fetch(PDO::FETCH_ASSOC)) {
            ...
            $html .= "<td><a href=?request=beheer&pagina=bioscopen&func=verwijderBioscoop&biosID=" . $biosID . " onclick='return confirm(`Weet je zeker dat je deze bioscoop wilt verwijderen`)'>Verwijder</a></td>";
            $html .= "</tr>";
